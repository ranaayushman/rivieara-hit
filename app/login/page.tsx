    ...
    <>
      <style>{`
        ...
        .riv-google {
          ...
          letter-spacing: .08em; transition: all .3s; text-decoration: none;
        }
        ...
        >
          ...
          <div className="riv-inner">
            ...
            <div className="riv-body">
              ...
              <p className="riv-sub2">Welcome Back</p>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="riv-field">
                  <label>
                    <Lock size={12} style={{ color: "rgba(212,160,23,.55)" }} />
                    Password
                  </label>
                  <div className="riv-wrap">
                    <input
                ...
                <button type="submit" className="riv-submit" disabled={loading}>
                  ...
                  <span>{loading ? "Signing In…" : "Enter the Realm"}</span>
