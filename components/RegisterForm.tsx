          ...
          <div className="relative p-8 sm:p-10">
            ...
            <form className="space-y-5">
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  className="w-full py-2.5 pl-6 pr-2 rounded-full bg-[#110505] border border-[#ff3333]/40 hover:bg-[#1a0505] text-white font-medium flex items-center justify-between transition-all duration-300 group shadow-lg"
                >
                  <span className="mx-auto pl-8 text-base">Sign Up</span>
            ...
            {/* Google */}
            <button className="w-full py-3.5 rounded-full border border-[#ff3333]/40 bg-[#110505] hover:bg-[#1a0505] text-white text-xs sm:text-sm font-semibold transition-all duration-300 flex items-center justify-center gap-3">
